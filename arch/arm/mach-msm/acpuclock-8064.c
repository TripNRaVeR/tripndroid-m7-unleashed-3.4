...
static struct msm_bus_paths bw_level_tbl[] __initdata = {
	...
	[4] = BW_MBPS(4264), /* At least 533 MHz on bus. */
...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  144000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
...
static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {   144000, PLL_8, 0, 0x00 }, L2(0),   925000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   144000, PLL_8, 0, 0x00 }, L2(0),   875000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   144000, PLL_8, 0, 0x00 }, L2(0),   825000 },
...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	{ 1, {   144000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   950000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   950000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   950000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   962500 },
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	{ 1, {   144000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(1),   900000 },
